...
from kirin.dialects import scf, func, math, ilist
...
@dialect_group(python_basic.union([list, range, slice, scf, func, math]))
...
@dialect_group(python_basic.union([ilist, range, slice, scf, func, math]))
