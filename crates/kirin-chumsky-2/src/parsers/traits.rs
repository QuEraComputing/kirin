...
pub trait WithChumskyParser<'tokens, 'src: 'tokens, Language: LanguageChumskyParser<'tokens, 'src>>
{
...
pub trait LanguageChumskyParser<'tokens, 'src: 'tokens>:
    Dialect<TypeLattice: WithChumskyParser<'tokens, 'src, Self>>
    + WithRecursiveChumskyParser<'tokens, 'src, Self>
{
}

impl<'tokens, 'src: 'tokens, L> LanguageChumskyParser<'tokens, 'src> for L where
    L: Dialect<TypeLattice: WithChumskyParser<'tokens, 'src, Self>>
        + WithRecursiveChumskyParser<'tokens, 'src, Self>
{
}

impl<'tokens, 'src: 'tokens, Node> WithChumskyParser<'tokens, 'src, Self> for Node
where
    Node: LanguageChumskyParser<'tokens, 'src>
        + 'tokens,
{
