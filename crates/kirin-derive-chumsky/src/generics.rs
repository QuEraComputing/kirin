...
//!
//! This module re-exports `GenericsBuilder` from `kirin-derive-toolkit` for convenience.

// Re-export GenericsBuilder from the toolkit crate
pub use kirin_derive_toolkit::codegen::GenericsBuilder;
