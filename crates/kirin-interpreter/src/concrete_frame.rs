...
//! consuming the dialect [`Effect`] and driving a single deterministic path. A
...
use crate::{
    CallEffect, Callee, Effect, EnvIndex, Frame, FrameDriver, FrameEffect, InterpreterError, Scope,
