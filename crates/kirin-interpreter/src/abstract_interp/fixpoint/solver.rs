use crate::{FixpointProfile, Frame, InterpreterError};
    ...
    P: FixpointProfile,
{
    ...
    where
        Sem: OwnerSemantics<Self, P::SummaryKey, P::Summary, P::Frame, P::Completion, P::Error>,
        Deps: SummaryDependencyIndex<P::SummaryKey>,
        P::Error: From<Deps::Error>,
    {
        ...
        self.deps.ensure_owner(&owner).map_err(P::Error::from)?;
        Ok(())
    }

    pub fn solve<Sem>(&mut self, semantics: &mut Sem, entry: P::SummaryKey) -> Result<(), P::Error>
    where
        P::Frame: Frame<Self, P::Frame, P::Completion, P::Error>,
        Sem: OwnerSemantics<Self, P::SummaryKey, P::Summary, P::Frame, P::Completion, P::Error>,
        Deps: SummaryDependencyIndex<P::SummaryKey>,
        P::Error: From<InterpreterError> + From<Deps::Error>,
    {
    ...
    pub fn drain_worklist<Sem>(&mut self, semantics: &mut Sem) -> Result<(), P::Error>
    where
        P::Frame: Frame<Self, P::Frame, P::Completion, P::Error>,
        Sem: OwnerSemantics<Self, P::SummaryKey, P::Summary, P::Frame, P::Completion, P::Error>,
        Deps: SummaryDependencyIndex<P::SummaryKey>,
    ...
    fn apply_pending_summary_effects<Sem>(&mut self, semantics: &mut Sem) -> Result<(), P::Error>
    where
        Sem: OwnerSemantics<Self, P::SummaryKey, P::Summary, P::Frame, P::Completion, P::Error>,
        Deps: SummaryDependencyIndex<P::SummaryKey>,
        P::Error: From<InterpreterError> + From<Deps::Error>,
