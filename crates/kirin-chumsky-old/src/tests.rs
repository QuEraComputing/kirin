...
pub enum SimpleAST<'src> {
    Add {
        lhs: ast::Operand<'src, SimpleTypeLattice>,
        rhs: ast::Operand<'src, SimpleTypeLattice>,
    ...
    Function {
        ...
        function_type: ast::Spanned<ast::FunctionType<SimpleTypeLattice>>,
        body: ast::Spanned<ast::Block<'src, SimpleTypeLattice, SimpleAST<'src>>>,
        result: ast::Spanned<&'src str>,
    },
}
        ...
        recursive(|dialect| {
            let add = // %result = add %lhs, %rhs
                ssa_value()
                    ...
                    .then(operands::<I, SimpleLanguage>(2, Token::Comma))
            ...
            let func = ssa_value()
                ...
                .then(symbol())
                .then(function_type::<I, SimpleLanguage>())
                .then(
                    block::<I, SimpleLanguage>(dialect)
