...
use kirin_interpreter_13::algebra::Lift;
use kirin_interpreter_13::concrete::ConcreteInterp;
use kirin_interpreter_13::control::{Control, CursorExt};
use kirin_interpreter_13::cursor::{AbstractBlockCursor, BlockCursor};
use kirin_interpreter_13::env::{AbstractEnv, AbstractMode, ConcreteMode, Env};
...
use crate::interpreter13::cursor::{AbstractForCursor, AbstractIfCursor, ForCursor, IfCursor};
    ...
    T: CompileTimeValue,
{
    ...
    let carried = E::Value::new_product(init_values);
    let body_stage = env.current_stage();
    // Use the env's configurable for_widening_budget instead of hardcoded 10.
