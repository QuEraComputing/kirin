...
use kirin_interpreter_9::cursor::BlockCursor;
...
/// Phase 2 (CollectYield): reads the inbox (yield value from the body),
...
///
/// Iterates the loop body with widening until fixpoint or `max_iterations`.
