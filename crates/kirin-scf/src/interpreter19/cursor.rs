...
// ---------------------------------------------------------------------------
// AbstractIfCursor — abstract mode: pushes both branches, joins results.
// Uses BlockCursor<V, L> (unified cursor — no AbstractBlockCursor).
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// AbstractForCursor — abstract mode: fixpoint over loop body.
// Uses BlockCursor<V, L> (unified cursor — no AbstractBlockCursor).
// ---------------------------------------------------------------------------
