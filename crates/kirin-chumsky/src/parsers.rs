...
-> impl Parser<'tokens, I, ast::Spanned<ast::FunctionType<'tokens, 'src, L>>, ParserError<'tokens, 'src>>
where
    'src: 'tokens,
    I: TokenInput<'tokens, 'src>,
...
pub fn block_argument<'tokens, 'src: 'tokens, I, L>() -> impl Parser<
    'tokens,
    I,
    ast::Spanned<ast::BlockArgument<'tokens, 'src, L>>,
...
pub fn block_argument_list<'tokens, 'src: 'tokens, I, L>() -> impl Parser<
    'tokens,
    I,
    Vec<ast::Spanned<ast::BlockArgument<'tokens, 'src, L>>>,
    ParserError<'tokens, 'src>,
>
where
    'src: 'tokens,
...
-> impl Parser<'tokens, I, ast::Spanned<ast::BlockHeader<'tokens, 'src, L>>, ParserError<'tokens, 'src>>
where
    'src: 'tokens,
    I: TokenInput<'tokens, 'src>,
    L: Dialect + HasParser<'tokens, 'src, L>,
...
) -> impl Parser<'tokens, I, ast::Spanned<ast::Block<'tokens, 'src, L>>, ParserError<'tokens, 'src>>
where
    'src: 'tokens,
    I: TokenInput<'tokens, 'src>,
    L: Dialect + HasParser<'tokens, 'src, L>,
...
pub fn region<'tokens, 'src: 'tokens, I, L>(
    dialect: impl Parser<'tokens, I, L::Output, ParserError<'tokens, 'src>> + 'tokens,
) -> impl Parser<'tokens, I, ast::Region<'tokens, 'src, L>, ParserError<'tokens, 'src>>
where
    'src: 'tokens,
    I: TokenInput<'tokens, 'src>,
    L: Dialect + HasParser<'tokens, 'src, L>,
