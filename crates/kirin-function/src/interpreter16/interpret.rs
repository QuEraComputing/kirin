...
use kirin_interpreter_16::algebra::SingleStageCursorFor;
...
//
// Blanket impls for ConcreteInterp and AbstractInterp are provided here,
...
structural_error_impl!(Bind, "bind is not yet supported in interpreter16");
structural_error_impl!(
    Lambda,
