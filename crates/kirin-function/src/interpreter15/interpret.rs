...
use kirin_interpreter_15::algebra::SingleStageCursorFor;
use kirin_interpreter_15::concrete::ConcreteInterp;
use kirin_interpreter_15::control::Control;
use kirin_interpreter_15::env::Env;
...
structural_error_impl!(Bind, "bind is not yet supported in interpreter15");
structural_error_impl!(
    Lambda,
