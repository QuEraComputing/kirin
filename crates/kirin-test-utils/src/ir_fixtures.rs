...
pub fn build_add_one(
    ...
    stage.with_builder(|b| {
        ...
        let add = kirin_arith::Arith::<ArithType>::op_add(b, ba_x, c1.result);
        let ret = Return::<ArithType>::new(b, vec![add.result.into()]);
...
pub fn build_select_program(
    ...
    stage.with_builder(|b| {
        ...
        let ret_truthy = Return::<ArithType>::new(b, vec![truthy_val]);
        {
        ...
        let ret_falsy = Return::<ArithType>::new(b, vec![falsy_val]);
        {
...
pub fn build_branch_fork_program(
    ...
    stage.with_builder(|b| {
        ...
        let ret_neg = Return::<ArithType>::new(b, vec![neg_val]);
        {
        ...
        let ret_pos = Return::<ArithType>::new(b, vec![pos_val]);
        {
...
pub fn build_div_program(
    ...
    stage.with_builder(|b| {
        ...
        let div = kirin_arith::Arith::<ArithType>::op_div(b, ba_x, ba_y);
...
pub fn build_rem_program(
    ...
    stage.with_builder(|b| {
        ...
        let ba_x = b.block_argument().index(0);
        let ba_y = b.block_argument().index(1);
        let rem = kirin_arith::Arith::<ArithType>::op_rem(b, ba_x, ba_y);
