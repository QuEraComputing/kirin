...
pub struct SSAValue<'tokens, 'src: 'tokens, Language: LanguageChumskyParser<'tokens, 'src>> {
    pub name: &'src str,
    pub ty: Option<<Language::TypeLattice as WithChumskyParser<'tokens, 'src>>::Output>,
    pub span: SimpleSpan,
}
    ...
    SSAValue<'tokens, 'src, Language>
{
    pub fn new(
        name: &'src str,
        ty: Option<<Language::TypeLattice as WithChumskyParser<'tokens, 'src>>::Output>,
        span: SimpleSpan,
    ) -> Self {
        Self { name, ty, span }
    }
...
pub struct TypeofSSAValue<'tokens, 'src: 'tokens, Language: LanguageChumskyParser<'tokens, 'src>> {
    pub ty: <Language::TypeLattice as WithChumskyParser<'tokens, 'src>>::Output,
    pub span: SimpleSpan,
}
...
{
    pub fn new(
        ty: <Language::TypeLattice as WithChumskyParser<'tokens, 'src>>::Output,
        span: SimpleSpan,
    ) -> Self {
        Self { ty, span }
    }
