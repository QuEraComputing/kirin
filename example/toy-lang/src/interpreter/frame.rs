...
use kirin_interpreter::{
    ...
    HasLocation, RegionFrame, SpecializedFunctionFrame, StageFrame, StagedFunctionFrame,
    StandardFrame, StatementFrame, forward_through,
};
use kirin_scf::interpreter::ScfFrame;
...
#[derive(Clone, Debug, PartialEq, Eq, HasLocation, Frame, StageFrame)]
#[stage_frame(stage = crate::stage::Stage)]
