...
use kirin_function::interpreter13::interpret::{CallSeam, eval_call_for_dialect};
...
use kirin_interpreter_13::algebra::{Lift, Project, SingleStageCursorFor};
use kirin_interpreter_13::call_dispatch::CallDispatch;
...
use kirin_interpreter_13::execute::Execute;
use kirin_interpreter_13::interpretable::Interpretable;
use kirin_interpreter_13::pipeline::PipelineHandle;
use kirin_scf::ForLoopValue;
use kirin_scf::interpreter13::cursor::{
    AbstractForCursor, AbstractIfCursor, AbstractSCFCursor, ForCursor, IfCursor, SCFCursor,
};
use kirin_scf::interpreter13::interpret::ScfSeam;
...
mod tests {
    ...
    use kirin_interpreter_13::cursor::AbstractBlockCursor;

    use crate::interpreter13::{
