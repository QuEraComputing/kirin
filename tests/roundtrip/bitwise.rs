...
use kirin_test_languages::BitwiseFunctionLanguage;
...
fn test_composes_with_constant_and_control_flow() {
    ...
    let ret_stmt = Return::<ArithType>::new(&mut stage, vec![and_stmt.result.into()]);
...
specialize @bitwise fn @compose(i64, i64, u32, u32) -> i64 cfg {
