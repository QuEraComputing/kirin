...
- A type lattice (`Dialect::TypeLattice`)
...
```rust
// Works with any TypeLattice
pub struct Constant<T: CompileTimeValue, L: TypeLattice> { ... }
```
...
- **Lattice-based types** — `TypeLattice` enables type inference via join/meet operations
